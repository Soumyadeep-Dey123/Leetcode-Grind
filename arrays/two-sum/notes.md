...
- Lets ignore the follow up. Loop through the array, find the first element, run a nested loop to find the second element

> Solution got accepted but was quite slow, although memory efficient
